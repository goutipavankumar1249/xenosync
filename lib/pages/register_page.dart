  ...
  Widget _profileImageField() {
    return GestureDetector(
      ...
      child: _profileImage != null
        ...
        backgroundImage: FileImage(File(_profileImage!.path!)), // Displaying the image file
      )
          : CircleAvatar(
        radius: _deviceHeight * 0.075,
        backgroundImage: NetworkImage("https://i.pravatar.cc/150?img=65"), // Default profile image
      ),
    );
  }

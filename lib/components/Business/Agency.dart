  ...
  void saveRoleToFirebase(String userId) async {
    if (selectedRole != null) {
      ...
      await databaseRef.child('users/$userId').update({
        'agency': selectedRole, // Add/update the role
      });
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DetailsForBrand()),
      );
    } else {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 30),
            // Role buttons
            buildRoleButton("Digital Marketing"),
            buildRoleButton("Creative Agency"),
            buildRoleButton("Advertising Agency"),
            buildRoleButton("Event Planning"),
